 ...
 * fuera de vista después de scrollear.
 *
 ...
 */
export function TodayMarker({ left, label }: { left: number; label: string }) {
  ...
  return (
    <div
      ...
      onFocus={showTooltip}
      onBlur={hideTooltip}
      className="absolute top-0 z-20 h-full w-px cursor-pointer bg-amber-400 outline-none hover:w-0.5 hover:bg-amber-500"
      style={{ left }}
    >
      {tooltipPos &&
        tooltipLayer &&
