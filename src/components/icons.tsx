// Set mínimo de iconos propios (stroke consistente, 1.5px, 24x24) — evita
// tanto emoji como sumar una librería entera por cuatro glifos.
...
// Play — inicio retrasado (debería haber arrancado y no arrancó).
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className={className}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M15.91 11.672a.375.375 0 0 1 0 .656l-5.603 3.113a.375.375 0 0 1-.557-.328V8.887c0-.286.307-.466.557-.327l5.603 3.112ZM21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"
      />
    </svg>
  );
}

// Reloj — tarea por vencer (el tiempo se está acabando, distinto del
// triángulo de "vencida"/urgente).
...
// Candado — tarea bloqueada (forma asociada directamente al significado).
...
export function ReviewChecklistIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className={className}>
      <path
        strokeLinecap="round"
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className={className}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="m18.375 12.739-7.693 7.693a4.5 4.5 0 0 1-6.364-6.364l10.94-10.94A3 3 0 1 1 19.5 7.372L8.552 18.32m.009-.01-.01.01"
      />
    </svg>
  );
}
...
// Dos círculos superpuestos — se usa para marcar colisiones de agenda (misma
// persona con tareas simultáneas en proyectos distintos): a propósito NO es
// un ícono de alerta (no es rojo/triángulo), porque no es grave, es solo
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className={className}>
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M13.5 10.5 21 3m0 0h-5.25M21 3v5.25M11.42 15.17l-2.83 2.83a4 4 0 0 1-5.66-5.66l2.83-2.83m8.13 2.13 2.83-2.83a4 4 0 0 0-5.66-5.66l-2.83 2.83"
      />
    </svg>
  );
}

// Confirmación breve de "acción hecha" (ej. copiar al portapapeles).
